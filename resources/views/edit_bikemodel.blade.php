            ...
            <div class="container-fluid">
                ...
                <div class="main-content">
                    <div class="row">
                      ...
                      <form class="form-horizontal" method="POST" action="{{url('post_edit_bikemodel')}}" enctype="multipart/form-data">
                                 {{ csrf_field() }}
