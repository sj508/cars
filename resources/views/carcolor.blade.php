                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Car color List</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-lg-12 p-l-0">
                                ...
                                <div class="stat-widget-eight">
                                    <div class="stat-header page-titles">
                                        <div class="header-title">Car Color manage</div>
                                        <div class="card-option drop-menu pull-right"><i class="ti-more-alt three-dot" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" role="link"></i>
                                            <ul class="card-option-dropdown dropdown-menu">
                                                ...
                                                <li><a href="#" data-toggle="modal" data-target="#add-users"><i class="ti-pulse"></i>Add Car color</a></li>
                                ...
                                <div class="bootstrap-data-table-panel">
                                    <div class="table-responsive">
                                      ...
                                      <!--   <a class="ac_btn" href=""><i class="fa fa-eye" aria-hidden="true"></i></a> -->
                                        <a class="ac_btn" href="{{url('edit_carcolor/'.$user->id)}}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> 
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <h4 class="modal-title"><strong>Delete Car color</strong></h4>
                                                    </div>
                                                
                                                <div class="modal-body">
                                        <span class="adminpro-icon adminpro-warning modal-check-pro information-icon-pro"></span>
                                        <h2>Delete car color??</h2>
                                        <p>Are you Sure you want to delete it?</p>
                                             </div>  
                                             
                                                       <div class="modal-footer">
                                                        <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Close</button>
                                                        <a  href="{{url('delete_carcolor/'.$user->id)}}"  class="btn btn-danger waves-effect waves-light">Submit</a>
                                                    </div>   
 ...
 <!--MODAL -->
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            <h4 class="modal-title"><strong>Add Car color</strong></h4>
         </div>
         <div class="modal-body">
            <form method="POST" action="{{'create_color'}}" enctype="multipart/form-data">
               {{ csrf_field() }}
               <div class="row">

                 
                   <div class="col-md-12">
                     <label class="control-label">Car color Name</label>
